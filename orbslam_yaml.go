...
func (slamSvc *orbslamService) orbCamMaker(camProperties *transform.PinholeCameraModel) (*ORBsettings, error) {
	var err error
...
func (slamSvc *orbslamService) orbGenYAML(ctx context.Context, cam camera.Camera) error {
...
func (slamSvc *orbslamService) orbConfigToInt(key string, def int) (int, error) {
...
func (slamSvc *orbslamService) orbConfigToFloat(key string, def float64) (float64, error) {
	valStr, ok := slamSvc.configParams[key]
	if !ok {
...
func (slamSvc *orbslamService) checkMaps() (string, string, error) {
